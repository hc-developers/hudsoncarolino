 ...
 */
    ...
    **********************************************/
            ...
            Redux::setSection( $opt_name, array(
                    ...
                    'fields'           => array(
                        ...
                        array(
                            'id'       => 'opt_Copyryght',
                            'type'     => 'text',
                            'title'    => __( 'Copyryght', 'redux-framework-demo' ),
                            'desc'    => __( '', 'redux-framework-demo' ),
                        ),
                        array(
                            'id'       => 'opt_info_rodape',
                            'type'     => 'text',
                            'title'    => __( 'Info Rodapé', 'redux-framework-demo' ),
                            'desc'    => __( 'HUDSON CAROLINO|DESENVOLVEDOR WEB', 'redux-framework-demo' ),
                        ),
                        array(
                            'id'       => 'opt_letras_load',
                            'type'     => 'multi_text',
                            'title'    => __( 'Frases Load', 'redux-framework-demo' ),
                            'desc'    => __( '', 'redux-framework-demo' ),
                        ),
                    )
                )
        ...
        //SESSÃO PÁGINA INICIAL
        Redux::setSection( $opt_name, array(
            'title'            => __( 'Configurações de contato', 'redux-framework-demo' ),
            ...
            Redux::setSection( $opt_name, array(
                    ...
                    'fields'           => array(
                        array(
                            ...
                            'desc'    => __( 'https://www.facebook.com/', 'redux-framework-demo' ),
                        ),
                        array(
                            'id'       => 'opt_linkedin',
                            'type'     => 'text',
                            'title'    => __( 'Linkedin', 'redux-framework-demo' ),
                            'desc'    => __( 'https://www.linkedin.com/', 'redux-framework-demo' ),
                        ),
                        array(
                            'id'       => 'opt_instagram',
                            'type'     => 'text',
                            'title'    => __( 'Instagram', 'redux-framework-demo' ),
                            'desc'    => __( 'https://www.instagram.com/', 'redux-framework-demo' ),
                        ),
            ...
            // CONFIGURAÇÕES DE CONTATO
            Redux::setSection( $opt_name, array(
                    'title'            => __( 'Informações de contato', 'redux-framework-demo' ),
                    'id'               => 'redes_contato',
                    'subsection'       => true,
                    'desc'             => __( 'Configurações', 'redux-framework-demo' ),
                    'customizer_width' => '450px',
