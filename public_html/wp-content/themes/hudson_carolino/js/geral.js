$(function(){
	...
	/*******************************************************
		SCRIPT HEADER
	*******************************************************/
		$(".topo .menu ul li a").addClass("scrollTop");
	...
	*******************************************************/
		...
		$(document).ready(function() {
			...
			$("#carrosselDepoimentos").owlCarousel({
	  		...
	  		$('#depoimentosLeft').click(function(){ carrossel_depoimentos.prev(); });
			$('#depoimentosRight').click(function(){ carrossel_depoimentos.next(); });
