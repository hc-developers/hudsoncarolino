...
// CHAMANDO ARQUIVOS 
	function hudson_carolino_scripts() {
	    ...
	    //JAVA SCRIPT
	    wp_enqueue_script( 'hudson_carolino-jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js' );
	    wp_enqueue_script( 'hudson_carolino-bootsrap', get_template_directory_uri() . '/js/bootstrap.min.js' );
	    wp_enqueue_script( 'hudson_carolino-carousel', get_template_directory_uri() . '/js/owl.carousel.min.js' );
	    wp_enqueue_script( 'hudson_carolino-geral', get_template_directory_uri() . '/js/geral.js' );

	    //CSS
	    wp_enqueue_style( 'hudson_carolino-bootstrap', get_template_directory_uri() . '/css/bootstrap.min.css');
	    wp_enqueue_style( 'hudson_carolino-font-awesome', get_template_directory_uri() . '/css/font-awesome.css');
	    wp_enqueue_style( 'hudson_carolino-owlcarousel', get_template_directory_uri() . '/css/owl.carousel.css');
	    wp_enqueue_style( 'hudson_carolino-animate', get_template_directory_uri() . '/css/animate.css');
...
function register_my_menus() {
	register_nav_menus(
		array(
			'menuHudsonCarolino' => __('Menu Principal'),
		)
	);
}
