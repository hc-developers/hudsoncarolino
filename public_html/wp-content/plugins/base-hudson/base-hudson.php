 ...
 */
		...
		function metaboxesHudson_Carolino(){
			...
			function registraMetaboxes( $metaboxes ){
				...
				$metaboxes[] = array(
					...
					'id'			=> 'metaboxHabilidades',

					'title'			=> 'Detalhes',

					'pages' 		=> array('habilidades'),
					...
					'fields' 		=> array(
						...
						array(
							...
							'name'  => 'ícone fontawesome: ',

							'id'    => "{$prefix}habilidade_icone",

							'placeholder'  => 'fa-html5',
				...
				$metaboxes[] = array(
					...
					'fields' 		=> array(
						...
						array(
							...
							'name'  => 'Foto ilustrativa: ',

							'id'    => "{$prefix}inicial_foto_ilustrativa",
						...
						array(
							...
							'name'  => 'Texto Front-End: ',

							'id'    => "{$prefix}inicial_texto",
	...
	*****************************************************/
		...
		function taxonomiaCategoriaHabilidades() {



			$rotulosCategoriaHabilidades = array(

												'name'              => 'Categorias de habilidade',

												'singular_name'     => 'Categorias de habilidades',

												'search_items'      => 'Buscar categoria do habilidade',
												...
												'edit_item'         => 'Editar categoria do habilidade',
												...
												'menu_name'         => 'Categorias habilidades',

											);



			$argsCategoriaHabilidades 		= array(

												'hierarchical'      => true,

												'labels'            => $rotulosCategoriaHabilidades,
												...
												'rewrite'           => array( 'slug' => 'categoria-habilidades' ),

											);



			register_taxonomy( 'categoriaHabilidades', array( 'habilidades' ), $argsCategoriaHabilidades);
